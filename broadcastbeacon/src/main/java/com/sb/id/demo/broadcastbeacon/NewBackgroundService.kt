...
class NewBackgroundService : Service() {
    companion object {
...
//                    }
    ...
    fun setNotification(context: Context): Notification {
        ...
        //disable viration
        //disable vibration
        val intent = Intent(context,NewBackgroundService::class.java)
        intent.action = ACTION_STOP_FOREGROUND_SERVICE
        val stopPendingIntent = PendingIntent.getBroadcast(context,0,intent, PendingIntent.FLAG_UPDATE_CURRENT)
